...
xcopy /y /s lib\3138\*.jar .\target\client
xcopy /y /s lib\3138\*.dll .\target\client\test
...
jarsigner -keystore src\client\keystore -storepass philemon .\target\client\swt_native_lib.jar typewise
